...
// Create a static boundaries
 const boundaries = [
  ...
  Bodies.rectangle(0, container_height / 2, 1, container_height, { isStatic: true }), // Left
  Bodies.rectangle(container_width, container_height / 2, 1, container_height, { isStatic: true }), // Right
  Bodies.rectangle(container_width / 2, container_height, container_width, 1, { isStatic: true }), // Bottom
];
